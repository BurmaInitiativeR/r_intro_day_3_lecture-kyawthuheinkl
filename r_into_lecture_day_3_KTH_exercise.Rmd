...
#sumstat of sepal.Length by species
df2 %>% 
  group_by(Species) %>%
...
#sumstat of sepal.width by species
df2 %>% 
  group_by(Species) %>% 
...
#sumstat of Petal.Length by species
df2 %>% 
  group_by(Species) %>% 
...
#sumstat of Petal.width by species
df2 %>% 
  group_by(Species) %>%
...
```
```{r select from species}
#sumstat of sepal.Length by species filter by value
df2 %>% 
  group_by(Species) %>%
...
#sumstat of sepal.width by species filter by value
df2 %>% 
  group_by(Species) %>%
...
#sumstat of Petal.Length by species filter by value
df2 %>% 
  group_by(Species) %>%
  filter(Species == "versicolor" | Species == "virginica") %>%
  summarise(mean = mean(Petal.Length, na.rm = TRUE),
...
#sumstat of Petal.width by species filter by value
df2 %>% 
  group_by(Species) %>%
  filter(Species == "versicolor" | Species == "virginica") %>%
  summarise(mean = mean(Petal.Width, na.rm = TRUE),
